...
def main():
    parser = argparse.ArgumentParser(
        description="For one or more packages, clone the git repository and"
                    " build the debian source package as well as an rpm .spec"
                    " file. This is the same code that runs to generate source"
                    " packages which we upload to https://obs.osmocom.org."
